...
{
	int id; //host id
	int x, y; //coordinates of the Host
	int t; //duration since host became infected 
	enum TYPE type; //host type: S, I, or R
    //S is for susceptible, I is for infected, R is for recovered
} THost;
...
//the double pointer is used to modify the head pointer itself
